  ...
  return (
    <div className="about-us-home">
      ...
      <div className="flex flex-col gap-10 pl-24">
        ...
        <div>
          <p className="font-secondary font-normal text-base text-[#333333]">Henry Hope Engineering 
      ...
      <div className="flex flex-col gap-10 justify-start items-start font-secondary p-10 bg-[#aab2d1] w-[50%]">
        <div className="home-service-tag flex gap-5 justify-center items-center">
